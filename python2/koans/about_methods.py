...
class AboutMethods(Koan):
    ...
    def test_calling_functions_with_wrong_number_of_arguments(self):
        ...
        try:
            ...
            self.assertMatch(expected_message, e[0])
    ...
    def test_the_documentation_can_be_viewed_with_the_doc_method(self):
        expected_doc = \
        "A string placed at the beginning of a function"
        "is used for documentation"
        self.assertMatch(expected_doc, self.method_with_documentation.__doc__)
