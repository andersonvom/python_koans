...
class AboutSets(Koan):
    def test_sets_make_keep_lists_unique(self):
        ...
        only_one = ['MacLeod', 'Ramirez', 'Matunas', 'Malcolm']
        self.assertEqual(set(only_one), there_can_only_be_only_one)
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        subtraction = ['Willie']
        self.assertEqual(set(subtraction), scotsmen - warriors)
        conjunction = ['MacLeod', 'Wallace', 'Willie', 'Leonidas']
        self.assertEqual(set(conjunction), scotsmen | warriors)
        disjunction = ['MacLeod', 'Wallace']
        self.assertEqual(set(disjunction), scotsmen & warriors)
        exclusive_or = ['Willie', 'Leonidas']
        self.assertEqual(set(exclusive_or), scotsmen ^ warriors)
