...
class AboutAttributeAccess(Koan):
    ...
    def test_all_attribute_reads_are_caught(self):
        ...
        expected = "Someone called 'foobar' and it could not be found"
        self.assertMatch(expected, catcher.foobar)

    def test_intercepting_return_values_can_disrupt_the_call_chain(self):
        catcher = self.CatchAllAttributeReads()

        expected = "Someone called 'foobaz' and it could not be found"
        self.assertMatch(expected, catcher.foobaz)  # This is fine
    ...
    def test_changing_getattribute_will_affect__the_getattr_function(self):
        ...
        expected = "Someone called 'any_attribute' and it could not be found"
        self.assertMatch(expected, getattr(catcher, 'any_attribute'))
    ...
    def test_non_foo_messages_are_treated_normally(self):
        ...
        try:
            ...
            expected = "'WellBehavedFooCatcher' object has no attribute 'normal_undefined_attribute'"
            self.assertMatch(expected, ex[0])
